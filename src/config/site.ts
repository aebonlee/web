...
export interface MenuItem {
  ...
  megaDropdown?: { columns: MegaDropdownColumn[] };
}
...
const site = {
  ...
  nameKo: '웹 개발 학습',
  description: '웹 개발의 모든 것 — HTML, CSS, JS, React, TypeScript까지 도장깨기로 마스터',
  ...
  menuItems: [
    ...
    { path: '/guide', labelKey: 'guide', activePath: '/guide' },
    {
      ...
      dropdown: [
        { path: '/html', labelKey: 'html' },
        { path: '/css', labelKey: 'css' },
    ...
    { path: '/vibecoding', labelKey: 'vibeCoding', activePath: '/vibecoding' },
    {
      ...
      dropdown: [
        { path: '/react', labelKey: 'react' },
        { path: '/typescript', labelKey: 'typescript' }
      ]
    },
    {
      ...
      dropdown: [
        ...
        { path: '/backend', labelKey: 'backend' },
        { path: '/devops', labelKey: 'devops' }
      ]
    },
    { path: '/problems', labelKey: 'problems', activePath: '/problems' },
    { path: '/playground', labelKey: 'playground', activePath: '/playground' },
    { path: '/progress', labelKey: 'progress', activePath: '/progress' }
  ] as MenuItem[],
  ...
  categories: [
    {
      ...
      labelKey: 'beginner',
      color: '#00B894',
      descriptionKey: 'beginnerDesc'
    },
    {
      id: 'intermediate',
      labelKey: 'intermediate',
      color: '#FDCB6E',
      descriptionKey: 'intermediateDesc'
    },
    {
      id: 'advanced',
      labelKey: 'advanced',
      color: '#E17055',
      descriptionKey: 'advancedDesc'
    },
    {
      id: 'practical',
      labelKey: 'practical',
      color: '#6C5CE7',
      descriptionKey: 'practicalDesc'
    }
  ],
