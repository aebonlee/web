                  ...
                  <div className="color-picker-tooltip">
                    ...
                    {site.colors.map((c) => (
                      <button
                        ...
                        onClick={() => { setColorTheme(c.name as import('../../types').ColorTheme); setShowColorPicker(false); }}
              ...
              <div className="nav-user-menu" ref={userMenuRef}>
                ...
                {showUserMenu && (
                  <div className="nav-user-dropdown">
                    ...
                    <Link to="/profile" className="dropdown-menu-item" onClick={() => setShowUserMenu(false)}>
                      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                      {t('auth.myPage')}
                    </Link>
                    <Link to="/progress" className="dropdown-menu-item" onClick={() => setShowUserMenu(false)}>
                      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>
                      {t('progress')}
                    </Link>
                    {isAdmin && (
                      <Link to="/admin/dashboard" className="dropdown-menu-item" onClick={() => setShowUserMenu(false)}>
