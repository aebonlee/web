...
export default function About(): ReactElement {
  return (
    <>
      <SEOHead title="About | Web Development" description="웹 개발의 모든 것 — HTML, CSS, JS, React, TypeScript까지 도장깨기로 마스터" />
        ...
        <div className="container">
          ...
          <div style={{
            ...
            <strong style={{ fontSize: '17px', display: 'block', marginBottom: '12px' }}>
              이 사이트는 웹 개발의 모든 것을 도장깨기로 마스터하는 학습 플랫폼입니다.
            </strong>
            <p style={{ margin: 0 }}>
              드림아이티비즈(DreamIT Biz)는 기업과 개인의 실제 니즈를 반영한 맞춤형 교육 플랫폼을 제작합니다.
              HTML, CSS, JavaScript, React, TypeScript까지 웹 개발 기술을 단계별로 학습합니다.
            </p>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '20px', marginBottom: '48px' }}>
            {[
              { icon: 'fa-html5', title: 'HTML/CSS', desc: '웹 페이지의 기본 구조와 스타일링을 학습합니다.' },
              { icon: 'fa-js', title: 'JavaScript', desc: '웹의 핵심 프로그래밍 언어 JavaScript를 배웁니다.' },
              { icon: 'fa-react', title: 'React', desc: '모던 프론트엔드 프레임워크 React를 실습합니다.' },
              { icon: 'fa-code', title: 'TypeScript', desc: '타입 안전한 개발을 위한 TypeScript를 학습합니다.' },
            ].map((item, i) => (
              <div key={i} style={{
                display: 'flex',
                gap: '16px',
